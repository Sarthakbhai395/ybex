...
export default function Academy() {
  ...
  return (
    <div style={{ 
      ...
      {/* ── HERO ── */}
      <section style={{ position: 'relative', minHeight: 'auto', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-start', textAlign: 'center', paddingTop: '104px', paddingBottom: '60px', paddingLeft: '20px', paddingRight: '20px', overflow: 'hidden', zIndex: 2 }}>
        {/* Purple Glow Effects */}
